    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit Transaction category</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                <form enctype="multipart/form-data"
                                    action="{{ route('admin.transaction-category.update') }}" method="post">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $transactionCategory->id }}">
                                    <div class="form-group">
                                        <label for="name">Name <span class="text-red">*</span></label>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            id="name" value="{{ $transactionCategory->name }}" name="name"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="type" id="type">
                                                    @foreach ($types as $type)
                                                        <option value="{{ $type }}"
                                                            @if ($type == $transactionCategory->type) selected @endif>
                                                            {{ $type }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
