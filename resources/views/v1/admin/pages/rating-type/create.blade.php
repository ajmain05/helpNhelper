    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Create Rating Type</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.success') }}">Rating Type</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                <form enctype="multipart/form-data" action="{{ route('admin.rating-types.store') }}"
                                    method="post">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            id="highest_score" value="{{ old('highest_score') }}" name="highest_score"
                                            placeholder="Enter highest score" step="0.1">
                                        @error('highest_score')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
