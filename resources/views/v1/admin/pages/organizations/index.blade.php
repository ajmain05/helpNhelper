            ...
            <div class="container-fluid">
                ...
                <div class="mb-2">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.users.download', ['type' => 'organization']) }}"
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="organizationsDatatable"
                                        style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>Tracking Id</th>
...
@section('additional_scripts')
    <script>
        $('#organizationsDatatable').DataTable({
            processing: true,
            serverSide: true,
            ordering: false,
            ...
            ajax: '{{ route('admin.organizations.ajax') }}',
            columns: [{
                    data: 'sid',
                    name: 'sid'
                },
        ...
        function deleteOrganization(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('admin.organization.delete') }}",
                        type: 'post',
                        data: {
                            id: id,
                            _token: '{{ csrf_token() }}',
                        ...
                        success: function(data) {
                            ...
                            $('#organizationsDatatable').DataTable().ajax.reload();
                        },
                        error: function(data) {
                            Swal.fire(
                                'Error!',
                                'Organization application assigned to this organization',
                                'error'
                            )
                        }
                    });
