                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.bank') }}">Bank Account</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                <form enctype="multipart/form-data" action="{{ route('admin.bank-account.update') }}"
                                    method="post">
                                    @csrf
                                        ...
                                        <select class="form-control select2 @error('bank') is-invalid @enderror"
                                            ...
                                            @foreach ($banks as $bank)
                                                <option value="{{ $bank->id }}"
                                                    {{ $bank->id == $bankAccount->bank->id ? 'selected' : '' }}>
                                                    {{ $bank->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ $bankAccount->branch_name }}" name="branch_name"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="opening_balance" value="{{ $bankAccount->opening_balance }}"
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            id="remarks" value="{{ $bankAccount->remarks }}" name="remarks"
                                            >
                                        @error('remarks')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
