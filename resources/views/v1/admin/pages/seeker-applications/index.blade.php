    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Seeker Applications</h1>
                    </div>
                    {{-- <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active">Seeker Applications</li>
                        </ol>
                    </div> --}}
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <a href="{{ route('admin.seeker-application.create') }}"
...
@section('additional_scripts')
    <script>
        $('#seekerApplicationsDatatable').DataTable({
            processing: true,
            serverSide: true,
            ordering: false,
            ...
            ajax: '{{ route('admin.seeker-applications.ajax') }}',
            columns: [{
                    data: 'sid',
                    name: 'sid'
                },
        ...
        function deleteSeekerApplication(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('admin.seeker-application.delete') }}",
                        type: 'post',
                        data: {
                            id: id,
                            _token: '{{ csrf_token() }}',
                        ...
                        success: function(data) {
                            ...
                            $('#seekerApplicationsDatatable').DataTable().ajax.reload();
                        },
                        error: function(data) {
                            Swal.fire(
                                'Error!',
