    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Create Seeker Application</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <form enctype="multipart/form-data" action="{{ route('admin.seeker-application.store') }}"
                                    method="post">
                                    @csrf

                                    <div class="form-group">
                                        <label for="seeker_id">Seeker <span class="text-red">*</span></label>
                                        <select class="form-control select2 @error('seeker_id') is-invalid @enderror"
                                            id="seeker_id" name="seeker_id">
                                            @foreach ($seekers as $seeker)
                                                <option value="{{ $seeker->id }}"
                                                    {{ $seeker->id == old('seeker_id') ? 'selected' : '' }}>
                                                    {{ $seeker->name }} ({{ $seeker->email ?? $seeker->mobile }})
                                                    {{ $seeker->upazila->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('seeker_id')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('description_ar') is-invalid @enderror" id="description_ar" name="description_ar"
                                            placeholder="Enter description in Arabic">{{ old('description_ar') }}</textarea>
