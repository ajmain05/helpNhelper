            ...
            <div class="container-fluid">
                ...
                <div class="mb-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="m-0">Seekers</h1>
                        <a href="{{ route('admin.users.download', ['type' => 'seeker']) }}"
                        ...
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="seekersDatatable"
                                        style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>Tracking Id</th>
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#seekersDatatable').DataTable().ajax.reload();
                        },
                        error: function(data) {
                            Swal.fire(
                                'Error!',
                                'Seeker application assigned to this seeker',
                                'error'
                            )
                        }
                    });
