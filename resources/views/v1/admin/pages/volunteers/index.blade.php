            ...
            <div class="container-fluid">
                ...
                <div class="mb-2">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.users.download', ['type' => 'volunteer']) }}"
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover" id="volunteersDatatable"
                                        style="width: 100%">
                                        <thead>
                                            <tr>
                                                <th>Tracking Id</th>
...
@section('additional_scripts')
    <script>
        $('#volunteersDatatable').DataTable({
            ...
            ajax: '{{ route('admin.volunteers.ajax') }}',
            columns: [{
                    data: 'sid',
                    name: 'sid'
                },
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#volunteersDatatable').DataTable().ajax.reload();
                        },
                        error: function(data) {
                            Swal.fire(
                                'Error!',
