    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit Campaign Category</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <form enctype="multipart/form-data" action="{{ route('admin.campaign-category.update') }}"
                                    method="post">
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $campaignCategory->id }}">

                                    <div class="form-group">
                                        <label for="title">Title (English) <span class="text-red">*</span></label>
                                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                                            id="title" value="{{ $campaignCategory->title }}" name="title"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('title_bn') is-invalid @enderror"
                                            id="title_bn" value="{{ $campaignCategory->title_bn }}" name="title_bn"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('title_ar') is-invalid @enderror"
                                            id="title_ar" value="{{ $campaignCategory->title_ar }}" name="title_ar"
                                        ...
                                        <select class="form-control select2 @error('parent_id') is-invalid @enderror"
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    {{ $category->id == $campaignCategory->parent_id ? 'selected' : '' }}>
