    ...
    <div class="pt-[128px] pb-60"
        ...
        <div class="max-w-[1200px] mx-auto w-full flex flex-col">
            <div class="flex flex-col max-w-[580px]">
                <h3 class="text-[52px] font-semibold leading-[56px] tracking-[0] text-white mb-9">Join Upcoming Events &
                    Webiners
                </h3>
                <div class="flex flex-col gap-7 mb-9">
                    <div class="flex gap-6 border-white border-[1.5px] rounded-[24px] px-8 py-4">
                        ...
                        <div class="flex flex-col justify-center">
                            <h5 class="text-[22px] font-semibold leading-[25px] tracking-[0] text-white mb-4">Charity
                                Meetup-The
                                Future of Charity</h5>
                            <div class="flex">
                ...
                <h3 class="text-white text-[36px] font-medium leading-[40px] tracking-[0] mb-5">Your Help Is Very
                    Important
                </h3>
                <a href="#"
                    class="text-[18px] font-semibold leading-[28px] tracking-[0] py-5 px-10 text-white bg-[rgb(23_153_234)] rounded-full w-fit">Become
                    a Donor</a>
            </div>
        </div>
    </div>
